...
import com.sushe.mapper.BuildingMapper;
...
public class BuildingService {
    ...
    public PageInfo<Building> queryDid(Building building) {
        if(building != null && building.getPage() != null){
            PageHelper.startPage(building.getPage(),building.getLimit());
        }
        return new PageInfo<Building>(buildingMapper.queryDid(building));
    }
